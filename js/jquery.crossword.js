(function($){
	$.fn.crossword = function(entryData) {
			...
			*/
			...
			var info = '<div> <h2> Instrucciones </h2> <p>Este crucigrama se encuentra basado en la ley SOPA y ACTA, tiene palabras clave referidas a estas dos propuestas de leyes que trataron de implementarse en Estados Unidos en el 2012. Estas palabras claves estan basados en la opion publica de estas leyes. Le invitamos a resolver y reflexionar acerca de estos tratados.</p>   <h2> Elaboró: </h2> <p>Grupo 9CV11</p>  <p>Cortes Nicolas Josue Manuel</p> <p>Garfias Lopez Jose De Jesus</p> <p>Jauregui Lopez Arturo Daniel</p> <p>Saucedo Flores Isaac</p>   </div>';
			this.after('<div id="puzzle-clues"><h2>Horizontal</h2><ul id="across"></ul><h2>Vertical</h2><ul id="down"></ul>  ' + info + '  </div>');
